...
Public Class DtaGriEnterKeyDClass
    ...
    Private Sub Delete()
        ...
        For i As Integer = 0 To Me.SelectedCells.Count - 1
            Me.SelectedCells.Item(i).Value = Nothing
        Next
                ...
                For i As Integer = 0 To Cells.Count - 1
                    ...
                    For j As Integer = 0 To Columns.Length - 1
                        ...
                        If Not StartCol + j <= Me.Columns.Count - 1 Or
                            Not StartRow2 <= Me.Rows.Count - 1 Or
                            Not Char.IsNumber(Columns(j).ToString) Then

                            If Not Char.IsNumber(Columns(j).ToString) Then
                                'エラーメッセージの表示
                                MessageBox.Show("数字以外貼り付けできません", _
                                                "エラー", _
